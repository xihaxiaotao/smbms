...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>企业营业照：</strong><span><img src="${pageContext.request.contextPath }/statics/pic/小可爱.png" height="100" width="100"></span></p>
            <p><strong>组织机构代码证：</strong><span><img src="${pageContext.request.contextPath }/statics/pic/裸熊.jpeg" height="100" width="150"></span></p>
